  ...
  { name: 'Video', value: videoCount,fill:"#3DAB6A" },
    ...
    return (
        <div className='container mx-auto px-4 my-6 md:my-10'>
            <h2 className='font-semibold text-2xl md:text-3xl mb-8 md:mb-16 text-center'>Friendship Analytics</h2>
            <div className='flex flex-col md:flex-row justify-center shadow-sm p-3 md:p-5 border-slate-300 rounded-lg'>
